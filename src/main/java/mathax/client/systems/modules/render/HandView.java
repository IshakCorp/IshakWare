...
public class HandView extends Module {
    ...
    private final Setting<Boolean> mainHandSpinX = mainHand.add(new BoolSetting.Builder()
        .name("spin X")
    ...
    private final Setting<Boolean> mainHandSpinY = mainHand.add(new BoolSetting.Builder()
        .name("spin Y")
        .description("ishak spin ?")
        .defaultValue(false)
        .build()
    ...
    private final Setting<Boolean> mainHandSpinZ = mainHand.add(new BoolSetting.Builder()
        .name("spin Z")
        .description("ishak spin ?")
        .defaultValue(false)
        .build()
    ...
    private final Setting<Boolean> offHandSpinY = offHand.add(new BoolSetting.Builder()
        .name("spin Y")
        .description("ishak spin ?")
        .defaultValue(false)
        .build()
    ...
    private final Setting<Boolean> offHandSpinZ = offHand.add(new BoolSetting.Builder()
        .name("spin Z")
        .description("ishak spin ?")
        .defaultValue(false)
        .build()
    ...
    float rotXMain = rotationXMain.get().floatValue();
    float rotYMain = rotationYMain.get().floatValue();
    float rotZMain = rotationZMain.get().floatValue();

    float rotXOff = rotationXOff.get().floatValue();
    float rotYOff = rotationYOff.get().floatValue();
    float rotZOff = rotationZOff.get().floatValue();
