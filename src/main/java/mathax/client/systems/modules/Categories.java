...
public class Categories {
    ...
    public static final Category Ishak = new Category("Ishak", Items.DONKEY_SPAWN_EGG, Color.fromRGBA(MatHax.INSTANCE.MATHAX_COLOR.r, MatHax.INSTANCE.MATHAX_COLOR.g, MatHax.INSTANCE.MATHAX_COLOR.b, 255));
    ...
    public static void init() {
        ...
        Modules.registerCategory(Ishak);
