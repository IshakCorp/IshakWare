...
public class MatHax implements ClientModInitializer {
    ...
    public static List<String> getSplashes() {
        return Arrays.asList(
            ...
            Formatting.YELLOW + "stiki huesosi?",
            Formatting.YELLOW + "Nopeka Lox(",
            ...
            Formatting.YELLOW + "Ebal v0ky___",
            Formatting.YELLOW + "Ebal Elon_Tusk v rotik",
            Formatting.YELLOW + "ti gonish shtoli?",
            Formatting.RED + "IshakWare!?!!",
            Formatting.RED + "Mindoz?",
            Formatting.RED + "maga2008",

            // PERSONALIZED
            Formatting.YELLOW + "You're lox, " + Formatting.GRAY + MinecraftClient.getInstance().getSession().getUsername(),
            Formatting.YELLOW + "Owning with MatrixDisabler " + Formatting.GRAY + MinecraftClient.getInstance().getSession().getUsername(),
            Formatting.YELLOW + "MatrixDisbler " + Formatting.GRAY + MinecraftClient.getInstance().getSession().getUsername() + Formatting.RED + "?"
