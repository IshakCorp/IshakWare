...
public class RotationHelper {
    ...
    public static float[] lookAtEntity(Entity targetEntity) {
        ...
        if (targetEntity instanceof LivingEntity livingEntity)
            diffY = livingEntity.getEyeY() - mc.player.getEyeY() - 0.5;
        else
            diffY = (targetEntity.getBoundingBox().minY + targetEntity.getBoundingBox().maxY) / 2.0D - mc.player.getY() + mc.player.getEyeY() - 0.5;
